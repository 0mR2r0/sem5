...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{|c|c|c|}
			\hline
			\multicolumn{2}{ |c|}{Propiedades} &unidades\\ \hline
			Diametro & 3 & $mm$ \\ 
...
\begin{table}[ht]
	\caption{Propiedades del aire}
	\begin{center}
		\begin{tabular}{|c|c|c|}
			\hline
			\multicolumn{2}{ |c|}{Propiedad¨} & unidades \\ \hline
...
\begin{table}[ht!]
	\caption{Variables y constantes de las ecuaciones (\ref{Gas}) y (\ref{Solido}) }
	\begin{center}
		\begin{tabular}{|c|c|c|}
			\hline
			\multicolumn{2}{ |c|}{Modelo:Variables} & unidades \\ \hline
			$T_b$ & Temperatura del relleno(empaquetado) & $^\circ C$ \\ 
			$T_g$ &  Temperatura del gas & $^\circ C$ \\ \hline
			\multicolumn{2}{ |c|}{Modelo: Constantes} & unidades \\ \hline
...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|}
			\hline
			\multicolumn{2}{ |c|}{Coeficiente}&cantidad & unidades \\ \hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\textbf{\textbf{\bibliographystyle{ieeetr}
